      ...
      private
        ...
        def resolve_dependencies(yard_objects)
          ...
          yard_objects.each do |yard_object|
            ...
            object << factory.node(yard_object.superclass) if yard_object.type == :class && yard_object.superclass.name != :Object

            object << factory.node(yard_object.namespace) unless yard_object.namespace.path.empty?
